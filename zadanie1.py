...
#----------------vvv
def read_file(file_name_2):
    with open(file_name_2, encoding='utf-8') as data:
        f_r = DictReader(data)
        return list(f_r) #ящик со словарями2
#----------------^^^
...
def main():
  ...
  #----------------------vvv
            ...
            if not exists(file_name):
                print("исходный файл отсутствует, пожалуйста , создайте файл")
                continue
